...
//        boolean longRaceWin = (distance > 50) && (userCar.maxSpeed > opponentCar.maxSpeed); // на длинной дистанции
        boolean shortRaceWin = false;
        boolean longRaceWin = false;
        if (distance <= 15) {
            shortRaceWin = userCar.acceleration >= opponentCar.acceleration;
            longRaceWin = false;
        } else if (distance > 50) {
            longRaceWin = userCar.maxSpeed > opponentCar.maxSpeed;
            shortRaceWin = false;
        }
